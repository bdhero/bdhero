    ...
    public abstract class TSStream
    {
        public static readonly IDictionary<TSStreamType, Icon> CodecIconMap
            = new Dictionary<TSStreamType, Icon>
                  {
                      { TSStreamType.AC3_AUDIO, null /* CodecIcons.dd */ },
                      { TSStreamType.AC3_PLUS_AUDIO, null /* CodecIcons.dd_plus */ },
                      { TSStreamType.AC3_PLUS_SECONDARY_AUDIO, null /* CodecIcons.dd_plus */ },
                      { TSStreamType.AC3_TRUE_HD_AUDIO, null /* CodecIcons.truehd */ },

                      { TSStreamType.DTS_AUDIO, null /* CodecIcons.dts */ },
                      { TSStreamType.DTS_HD_AUDIO, null /* CodecIcons.dts_hd */ },
                      { TSStreamType.DTS_HD_MASTER_AUDIO, null /* CodecIcons.dts_hd */ },
                      { TSStreamType.DTS_HD_SECONDARY_AUDIO, null /* CodecIcons.dts_hd */ },

                      { TSStreamType.LPCM_AUDIO, null /* CodecIcons.lpcm */ },

                      { TSStreamType.MPEG1_AUDIO, null /* CodecIcons.mpeg1_audio */ },
                      { TSStreamType.MPEG2_AUDIO, null /* CodecIcons.mpeg2_audio */ },

                      { TSStreamType.AVC_VIDEO, null /* CodecIcons.avc */ },
                      { TSStreamType.MPEG1_VIDEO, null /* CodecIcons.mpeg1_video */ },
                      { TSStreamType.MPEG2_VIDEO, null /* CodecIcons.mpeg2_video */ },
                      { TSStreamType.VC1_VIDEO, null /* CodecIcons.vc1 */ },

                      { TSStreamType.PRESENTATION_GRAPHICS, null /* CodecIcons.pgs */ },
                      { TSStreamType.SUBTITLE, null /* CodecIcons.txt */ }
                  };

        public static Icon GetCodecIcon(TSStreamType streamType)
        {
            return CodecIconMap.ContainsKey(streamType) ? CodecIconMap[streamType] : null /* CodecIcons.unknown */;
        }
